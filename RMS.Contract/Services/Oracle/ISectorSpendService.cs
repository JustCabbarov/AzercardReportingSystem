...
public interface ISectorSpendService
{
    ...
    Task<IEnumerable<BankDto>> GetDistinctBanksAsync(CancellationToken ct = default);
    Task<IEnumerable<MccGroupDto>> GetDistinctMccGroupsAsync(CancellationToken ct = default);
